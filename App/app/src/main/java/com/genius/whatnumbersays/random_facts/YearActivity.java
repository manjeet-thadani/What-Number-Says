...
public class YearActivity extends AppCompatActivity {
    ...
    private void register(String number) {
        class GetYearFact extends AsyncTask<String, Void, String> {
            ProgressDialog loading;

            @Override
            protected void onPreExecute() {
                super.onPreExecute();
                loading = new ProgressDialog(YearActivity.this);
            ...
            protected String doInBackground(String... params) {
                String urlDate = Constants.RANDOM_URL_YEAR;
        ...
        GetYearFact ru = new GetYearFact();
        ru.execute(number);
    }

    private void displayFact(String fact) {
        Bundle bundle = new Bundle();
        bundle.putString(Constants.BUNDLE_CATEGORY, "Year");
        bundle.putString(Constants.BUNDLE_TITLE, "Year - Fact");
        bundle.putString(Constants.BUNDLE_FACT, fact);
        bundle.putInt(Constants.BUNDLE_ICON, year);
