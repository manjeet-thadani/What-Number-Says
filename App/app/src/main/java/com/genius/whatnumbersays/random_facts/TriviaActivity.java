...
public class TriviaActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (isInternetOn()) {
            ...
            Toast.makeText(TriviaActivity.this, "Unable To Connect To Internet", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void register(String number) {
        class GetTriviaFact extends AsyncTask<String, Void, String> {
            ProgressDialog loading;

            @Override
            protected void onPreExecute() {
                super.onPreExecute();
                loading = new ProgressDialog(TriviaActivity.this);
            ...
            protected String doInBackground(String... params) {
                String urlDate = Constants.RANDOM_URL_TRIVIA;
        ...
        GetTriviaFact ru = new GetTriviaFact();
        ru.execute(number);
    }
    private void displayFact(String fact) {
        Bundle bundle = new Bundle();
        bundle.putString(Constants.BUNDLE_CATEGORY, "Trivia");
        bundle.putString(Constants.BUNDLE_TITLE, "Trivia - Fact");
        bundle.putString(Constants.BUNDLE_FACT, fact);
        bundle.putInt(Constants.BUNDLE_ICON, R.drawable.trivia);
